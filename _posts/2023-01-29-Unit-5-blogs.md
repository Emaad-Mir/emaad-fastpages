...
For our project, our team is currently deciding on two licenses: the MIT License and the Apache 2.0 License. While both licenses are important in giving users the right to use other peoples' material (complying with the license guidelines, of course), both of them have their benefits and drawbacks. Below are benefits and drawbacks of each license and the kind of positives/problems we might experience with each.
...
## 5.6: Obtaining Data via Crowdsourcing + Questions
